...
ADMINS = (
    'Ahmad Zidan', 'ahmadzidan@mail.ugm.ac.id'
)
...
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL', 'admin@pemilu-kmtk.xyz')
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Pemilu KMTK')
...
HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'admin@pemilu-kmtk.xyz')
